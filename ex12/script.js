function botao(){
    ...
    if (temperaturaC.value == '') {
        ...
        if (temperaturaF>= 85) {
            document.getElementById('ilustração').innerHTML = '<img src="fotos/calor.jpg" alt="Foto calor">'
            document.body.style.background = 'rgb(247, 220, 171)'
        } else {
            document.getElementById('ilustração').innerHTML = '<img src="fotos/frio.webp" alt="Foto frio">'
